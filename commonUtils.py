...
best_evm_power_byte_location = {
    "2.4": {
        "11b": {"20": {"1": "211", "2": "212", "5.5": "213", "11": "214"}},
        "11g": {"20": {"9": "216"}},
        "11n": {
            "20": {
                "MCS0": "215",
...
sensitivity_dict_range = {
    ...
    "11b": {"1x1": {"20": {"1": [-80, -100], "2": [-80, -100], "5.5": [-80, -100], "11": [-80, -90]}}},
    "11g": {
        "1x1": {
            "20": {
                "6": [-85, -95],
...
snr_dict_range = {
    ...
    "11b": {"1x1": {"20": {"1": [-40, 30], "2": [-40, 30], "5.5": [-40, 30], "11": [-40, 30]}}},
    "11g": {
        "1x1": {
            "20": {
                "6": [-40, 30],
...
intf_dict_range = {
    ...
    "11b": {"1x1": {"20": {"1": [-10, -60], "2": [-10, -60], "5.5": [-10, -60], "11": [-10, -60]}}},
    "11g": {
        "1x1": {
            "20": {
                "6": [-10, -60],
...
pop_pkt_ifs_dict = {
    ...
    "40": {"11n_11n": 404, "11n_11ac": 396, "11ac_11n": 408, "11ac_11ac": 400},
    "80": {"11ac_11ac": 400},
}
...
def start_per(modulation, dr, ch, streams, standard, tester, dut, equipment, wave_type="default"):
    ...
    if per_status == "FAIL":
        ...
        return_data, per_status = dut.compute_per(
            modulation, dr, ch, streams, standard, tester, dut, equipment, wave_type
        )
        print(return_data, per_status)
        if per_status == "FAIL":
...
def get_tx_stats_from_vsa(txp, dr, ch, streams, standard, bw, equipment, cable_loss_1x1, cable_loss_2x2):
        ...
        try:
            if "2x2" in streams:
                (
                    ...
                    phaseimb_1x1,
                    phaseimb_2x2,
                ) = equipment.save_txquality_stats(dr, txp, ch, standard, streams)
                ...
                (
                    ...
                    ampimb_1x1,
                    phaseimb_1x1,
                ) = equipment.save_txquality_stats(
                    dr, txp, ch, standard, streams
                )  # CSV
                if "#" in str(evm_1x1):
                    equipment.click_analyser(standard, streams)
                    # time.sleep(10)
            ...
            if "2x2" in streams:
                ...
                evm_1x1 = (
                    phaseerr_1x1
                ) = freq_error_1x1 = sysclkerr_1x1 = lo_leakage_1x1 = ampimb_1x1 = phaseimb_1x1 = "0"
    ...
    for i in range(5):
        ...
        try:
            if "2x2" in streams:
                power_1x1, power_2x2 = equipment.save_power_values(
                    dr, txp, ch, standard, streams, cable_loss_1x1, cable_loss_2x2
                )
            else:
    ...
    try:
        if streams == "2x2":
            tx_data += [
                ...
                spectral_mask_1x1,
                spectral_mask_2x2,
                spectral_flatness_1x1,
                spectral_flatness_2x2,
                psdu_crc_1x1,
                psdu_crc_2x2,
            ]
